...
<script>
    ...
    $(document).ready(function () {
        $("#shareBtn").click(function () {
            ...
            var URL = 'http://homegurus.ca/PropertyDetails.aspx?MLSID=' + MLSID + '&PropertyType=' + PropertyType;
